...
public class ScreenTemp extends CustomAppCompatActivity {
    ...
    public void setupValues()
    {
        ...
        if(!(DataUtils.isStringValueExist(product_slug)))
            ...
            dbSQLiteHelper = CommonMethods.getDbModel(ScreenTemp.this);

            productModel = dbSQLiteHelper.getProductModel(product_slug);

            product_ref_id_tv.setText(productModel.ref_id);
            ViewUtils.setHeaderC1(ScreenTemp.this, findViewById(R.id.top_bar_header_ly), productModel.name);
